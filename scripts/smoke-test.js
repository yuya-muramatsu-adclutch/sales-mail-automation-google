...
assert(codeSource.includes('20260719_apps_script_full_workflow_v212_queue_workspace_navigation'));
...
assert(indexSource.includes('function selectLeadWorkspace'));
assert(indexSource.includes('lead-workspace-row-selected'));
...
assert(indexSource.includes('class="lead-stage-filter lead-workspace-tabs"'));
...
console.log('v212 queue workspace navigation regression tests passed.');
